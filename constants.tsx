...
export const TRANSLATIONS = {
  en: {
    ...
    errorApiKey: "Configuration Error: `API_KEY` is not configured.",
    errorApiKeyTitle: "Configuration Error",
    errorApiKeyMessage1: "The application cannot connect to the AI service because the `API_KEY` environment variable is missing.",
    errorApiKeyMessage2: "To fix this, please set the variable in your deployment settings. Based on your screenshot, you seem to be using Netlify. In Netlify, navigate to:",
    errorApiKeyMessage3: "Site settings → Build & deploy → Environment → Environment variables",
    errorApiKeyMessage4: "Create a new variable. The name must be exactly `API_KEY`. The value should be your secret key from Google AI Studio. Make sure the variable name doesn't contain any invalid characters like backslashes (`\\`) or dashes (`-`).",
  ...
  hi: {
    ...
    errorApiKey: "कॉन्फ़िगरेशन त्रुटि: `API_KEY` कॉन्फ़िगर नहीं है।",
    errorApiKeyTitle: "कॉन्फ़िगरेशन त्रुटि",
    errorApiKeyMessage1: "एप्लिकेशन AI सेवा से कनेक्ट नहीं हो सकता क्योंकि `API_KEY` पर्यावरण चर गुम है।",
    errorApiKeyMessage2: "इसे ठीक करने के लिए, कृपया अपनी परिनियोजन सेटिंग्स में चर सेट करें। आपके स्क्रीनशॉट के आधार पर, ऐसा लगता है कि आप नेटलिफाई का उपयोग कर रहे हैं। नेटलिफाई में, यहां जाएं:",
    errorApiKeyMessage3: "साइट सेटिंग्स → बिल्ड और परिनियोजन → पर्यावरण → पर्यावरण चर",
    errorApiKeyMessage4: "एक नया चर बनाएं। नाम बिल्कुल `API_KEY` होना चाहिए। मान Google AI स्टूडियो से आपकी गुप्त कुंजी होनी चाहिए। सुनिश्चित करें कि चर नाम में बैकस्लैश (`\\`) या डैश (`-`) जैसे कोई अमान्य वर्ण न हों।",
  ...
  bn: { 
    ...
    errorApiKey: "কনফিগারেশন ত্রুটি: `API_KEY` কনফিগার করা নেই।",
    errorApiKeyTitle: "কনফিগারেশন ত্রুটি",
    errorApiKeyMessage1: "অ্যাপ্লিকেশনটি AI পরিষেবার সাথে সংযোগ করতে পারছে না কারণ `API_KEY` এনভায়রনমেন্ট ভেরিয়েবলটি অনুপস্থিত।",
    errorApiKeyMessage2: "এটি ঠিক করতে, অনুগ্রহ করে আপনার ডিপ্লয়মেন্ট সেটিংসে ভেরিয়েবল সেট করুন। আপনার স্ক্রিনশটের উপর ভিত্তি করে, মনে হচ্ছে আপনি Netlify ব্যবহার করছেন। Netlify-তে, এখানে নেভিগেট করুন:",
    errorApiKeyMessage3: "সাইট সেটিংস → বিল্ড এবং ডিপ্লয় → এনভায়রনমেন্ট → এনভায়রনমেন্ট ভেরিয়েবল",
    errorApiKeyMessage4: "একটি নতুন ভেরিয়েবল তৈরি করুন। নামটি অবশ্যই `API_KEY` হতে হবে। মানটি Google AI Studio থেকে আপনার গোপন কী হওয়া উচিত। নিশ্চিত করুন যে ভেরিয়েবলের নামে ব্যাকস্ল্যাশ (`\\`) বা ড্যাশ (`-`) এর মতো কোনো অবৈধ অক্ষর নেই।",
  ...
  gu: { 
    ...
    errorApiKey: "રૂપરેખાંકન ભૂલ: `API_KEY` રૂપરેખાંકિત નથી.",
    errorApiKeyTitle: "રૂપરેખાંકન ભૂલ",
    errorApiKeyMessage1: "એપ્લિકેશન AI સેવા સાથે કનેક્ટ કરી શકતી નથી કારણ કે `API_KEY` પર્યાવરણ ચલ ખૂટે છે.",
    errorApiKeyMessage2: "આને સુધારવા માટે, કૃપા કરીને તમારી જમાવટ સેટિંગ્સમાં ચલ સેટ કરો. તમારા સ્ક્રીનશોટના આધારે, એવું લાગે છે કે તમે Netlify નો ઉપયોગ કરી રહ્યાં છો. Netlify માં, આના પર નેવિગેટ કરો:",
    errorApiKeyMessage3: "સાઇટ સેટિંગ્સ → બિલ્ડ અને જમાવટ → પર્યાવરણ → પર્યાવરણ ચલો",
    errorApiKeyMessage4: "એક નવો ચલ બનાવો. નામ બરાબર `API_KEY` હોવું આવશ્યક છે. મૂલ્ય Google AI સ્ટુડિયોમાંથી તમારી ગુપ્ત કી હોવી જોઈએ. ખાતરી કરો કે ચલના નામમાં બેકસ્લેશ (`\\`) અથવા ડેશ (`-`) જેવા કોઈ અમાન્ય અક્ષરો નથી.",
  ...
  kn: { 
    ...
    errorApiKey: "ಸಂರಚನಾ ದೋಷ: `API_KEY` ಅನ್ನು ಸಂರಚಿಸಲಾಗಿಲ್ಲ.",
    errorApiKeyTitle: "ಸಂರಚನಾ ದೋಷ",
    errorApiKeyMessage1: "`API_KEY` ಪರಿಸರ ವೇರಿಯಬಲ್ ಕಾಣೆಯಾಗಿರುವುದರಿಂದ ಅಪ್ಲಿಕೇಶನ್ AI ಸೇವೆಗೆ ಸಂಪರ್ಕಿಸಲು ಸಾಧ್ಯವಿಲ್ಲ.",
    errorApiKeyMessage2: "ಇದನ್ನು ಸರಿಪಡಿಸಲು, ದಯವಿಟ್ಟು ನಿಮ್ಮ ನಿಯೋಜನೆ ಸೆಟ್ಟಿಂಗ್‌ಗಳಲ್ಲಿ ವೇರಿಯಬಲ್ ಅನ್ನು ಹೊಂದಿಸಿ. ನಿಮ್ಮ ಸ್ಕ್ರೀನ್‌ಶಾಟ್ ಆಧರಿಸಿ, ನೀವು Netlify ಅನ್ನು ಬಳಸುತ್ತಿರುವಂತೆ ತೋರುತ್ತಿದೆ. Netlify ನಲ್ಲಿ, ಇಲ್ಲಿಗೆ ನ್ಯಾವಿಗೇಟ್ ಮಾಡಿ:",
    errorApiKeyMessage3: "ಸೈಟ್ ಸೆಟ್ಟಿಂಗ್‌ಗಳು → ನಿರ್ಮಿಸಿ ಮತ್ತು ನಿಯೋಜಿಸಿ → ಪರಿಸರ → ಪರಿಸರ ವೇರಿಯಬಲ್‌ಗಳು",
    errorApiKeyMessage4: "ಹೊಸ ವೇರಿಯಬಲ್ ಅನ್ನು ರಚಿಸಿ. ಹೆಸರು ನಿಖರವಾಗಿ `API_KEY` ಆಗಿರಬೇಕು. ಮೌಲ್ಯವು Google AI ಸ್ಟುಡಿಯೋದಿಂದ ನಿಮ್ಮ ರಹಸ್ಯ ಕೀಯಾಗಿರಬೇಕು. ವೇರಿಯಬಲ್ ಹೆಸರಿನಲ್ಲಿ ಬ್ಯಾಕ್‌ಸ್ಲ್ಯಾಶ್‌ಗಳು (`\\`) ಅಥವಾ ಡ್ಯಾಶ್‌ಗಳ (`-`)ಂತಹ ಯಾವುದೇ ಅಮಾನ್ಯ ಅಕ್ಷರಗಳಿಲ್ಲ ಎಂದು ಖಚಿತಪಡಿಸಿಕೊಳ್ಳಿ.",
  ...
  ml: {
    ...
    errorApiKey: "കോൺഫിഗറേഷൻ പിശക്: `API_KEY` കോൺഫിഗർ ചെയ്തിട്ടില്ല.",
    errorApiKeyTitle: "കോൺഫിഗറേഷൻ പിശക്",
    errorApiKeyMessage1: "`API_KEY` എൻവയോൺമെൻ്റ് വേരിയബിൾ ലഭ്യമല്ലാത്തതിനാൽ അപ്ലിക്കേഷന് AI സേവനത്തിലേക്ക് കണക്റ്റുചെയ്യാനാകില്ല.",
    errorApiKeyMessage2: "ഇത് പരിഹരിക്കുന്നതിന്, നിങ്ങളുടെ വിന്യാസ ക്രമീകരണങ്ങളിൽ വേരിയബിൾ സജ്ജമാക്കുക. നിങ്ങളുടെ സ്ക്രീൻഷോട്ട് അടിസ്ഥാനമാക്കി, നിങ്ങൾ Netlify ഉപയോഗിക്കുന്നതായി തോന്നുന്നു. Netlify-യിൽ, ഇതിലേക്ക് നാവിഗേറ്റുചെയ്യുക:",
    errorApiKeyMessage3: "സൈറ്റ് ക്രമീകരണങ്ങൾ → നിർമ്മിക്കുക & വിന്യസിക്കുക → പരിസ്ഥിതി → പരിസ്ഥിതി വേരിയബിളുകൾ",
    errorApiKeyMessage4: "ഒരു പുതിയ വേരിയബിൾ സൃഷ്ടിക്കുക. പേര് കൃത്യമായി `API_KEY` ആയിരിക്കണം. മൂല്യം Google AI സ്റ്റുഡിയോയിൽ നിന്നുള്ള നിങ്ങളുടെ രഹസ്യ കീ ആയിരിക്കണം. വേരിയബിളിൻ്റെ പേരിൽ ബാക്ക്സ്ലാഷുകൾ (`\\`) അല്ലെങ്കിൽ ഡാഷുകൾ (`-`) പോലുള്ള അസാധുവായ പ്രതീകങ്ങൾ ഇല്ലെന്ന് ഉറപ്പാക്കുക.",
  ...
  mr: {
    ...
    errorApiKey: "कॉन्फिगरेशन त्रुटी: `API_KEY` कॉन्फिगर केलेले नाही.",
    errorApiKeyTitle: "कॉन्फिगरेशन त्रुटी",
    errorApiKeyMessage1: "`API_KEY` पर्यावरण व्हेरिएबल गहाळ असल्यामुळे ॲप्लिकेशन AI सेवेशी कनेक्ट होऊ शकत नाही.",
    errorApiKeyMessage2: "हे दुरुस्त करण्यासाठी, कृपया तुमच्या उपयोजन सेटिंग्जमध्ये व्हेरिएबल सेट करा. तुमच्या स्क्रीनशॉटनुसार, तुम्ही Netlify वापरत आहात असे दिसते. Netlify मध्ये, येथे नेव्हिगेट करा:",
    errorApiKeyMessage3: "साइट सेटिंग्ज → तयार करा आणि उपयोजित करा → पर्यावरण → पर्यावरण व्हेरिएबल्स",
    errorApiKeyMessage4: "एक नवीन व्हेरिएबल तयार करा. नाव अचूक `API_KEY` असणे आवश्यक आहे. मूल्य Google AI स्टुडिओमधील तुमची गुप्त की असावी. व्हेरिएबलच्या नावात बॅकस्लॅश (`\\`) किंवा डॅश (`-`) सारखी कोणतीही अवैध अक्षरे नाहीत याची खात्री करा.",
  ...
  or: {
    ...
    errorApiKey: "କନଫିଗରେସନ୍ ତ୍ରୁଟି: `API_KEY` କନଫିଗର୍ ହୋଇନାହିଁ।",
    errorApiKeyTitle: "କନଫିଗରେସନ୍ ତ୍ରୁଟି",
    errorApiKeyMessage1: "`API_KEY` ପରିବେଶ ଭେରିଏବଲ୍ ନଥିବାରୁ ଆପ୍ଲିକେସନ୍ AI ସେବା ସହିତ ସଂଯୋଗ କରିପାରୁନାହିଁ।",
    errorApiKeyMessage2: "ଏହାକୁ ଠିକ୍ କରିବାକୁ, ଦୟାକରି ଆପଣଙ୍କର ନିୟୋଜନ ସେଟିଂସରେ ଭେରିଏବଲ୍ ସେଟ୍ କରନ୍ତୁ। ଆପଣଙ୍କ ସ୍କ୍ରିନସଟ୍ ଅନୁଯାୟୀ, ଆପଣ Netlify ବ୍ୟବହାର କରୁଥିବା ପରି ମନେହୁଏ। Netlify ରେ, ଏଠାକୁ ଯାଆନ୍ତୁ:",
    errorApiKeyMessage3: "ସାଇଟ୍ ସେଟିଂସ → ନିର୍ମାଣ ଏବଂ ନିୟୋଜନ → ପରିବେଶ → ପରିବେଶ ଭେରିଏବଲ୍ସ",
    errorApiKeyMessage4: "ଏକ ନୂଆ ଭେରିଏବଲ୍ ସୃଷ୍ଟି କରନ୍ତୁ। ନାମଟି ସଠିକ୍ ଭାବରେ `API_KEY` ହେବା ଆବଶ୍ୟକ। ମୂଲ୍ୟଟି Google AI ଷ୍ଟୁଡିଓରୁ ଆପଣଙ୍କର ଗୁପ୍ତ କୀ ହେବା ଉଚିତ୍। ନିଶ୍ଚିତ କରନ୍ତୁ ଯେ ଭେରିଏବଲ୍ ନାମରେ ବ୍ୟାକସ୍ଲାସ୍ (`\\`) କିମ୍ବା ଡ୍ୟାସ୍ (`-`) ଭଳି କୌଣସି ଅବୈଧ ଅକ୍ଷର ନାହିଁ।",
  ...
  ta: {
    ...
    errorApiKey: "உள்ளமைவு பிழை: `API_KEY` உள்ளமைக்கப்படவில்லை.",
    errorApiKeyTitle: "உள்ளமைவு பிழை",
    errorApiKeyMessage1: "`API_KEY` சூழல் மாறி இல்லாததால், பயன்பாட்டால் AI சேவையுடன் இணைய முடியவில்லை.",
    errorApiKeyMessage2: "இதை சரிசெய்ய, உங்கள் வரிசைப்படுத்தல் அமைப்புகளில் மாறியை அமைக்கவும். உங்கள் ஸ்கிரீன்ஷாட்டின் அடிப்படையில், நீங்கள் Netlify ஐப் பயன்படுத்துகிறீர்கள் என்று தெரிகிறது. Netlify இல், இதற்குச் செல்லவும்:",
    errorApiKeyMessage3: "தள அமைப்புகள் → உருவாக்கு & வரிசைப்படுத்து → சூழல் → சூழல் மாறிகள்",
    errorApiKeyMessage4: "புதிய மாறியை உருவாக்கவும். பெயர் சரியாக `API_KEY` ஆக இருக்க வேண்டும். மதிப்பு Google AI ஸ்டுடியோவிலிருந்து உங்கள் ரகசிய விசையாக இருக்க வேண்டும். மாறி பெயரில் பின்கோடுகள் (`\\`) அல்லது கோடுகள் (`-`) போன்ற தவறான எழுத்துக்கள் இல்லை என்பதை உறுதிப்படுத்தவும்.",
  ...
  te: {
    ...
    errorApiKey: "ఆకృతీకరణ లోపం: `API_KEY` ఆకృతీకరించబడలేదు.",
    errorApiKeyTitle: "ఆకృతీకరణ లోపం",
    errorApiKeyMessage1: "`API_KEY` పర్యావరణ వేరియబుల్ తప్పిపోయినందున అప్లికేషన్ AI సేవకు కనెక్ట్ చేయబడదు.",
    errorApiKeyMessage2: "దీన్ని పరిష్కరించడానికి, దయచేసి మీ విస్తరణ సెట్టింగ్‌లలో వేరియబుల్‌ను సెట్ చేయండి. మీ స్క్రీన్‌షాట్ ఆధారంగా, మీరు Netlifyని ఉపయోగిస్తున్నట్లు కనిపిస్తోంది. Netlifyలో, దీనికి నావిగేట్ చేయండి:",
    errorApiKeyMessage3: "సైట్ సెట్టింగ్‌లు → నిర్మించు & విస్తరించు → పర్యావరణం → పర్యావరణ వేరియబుల్స్",
    errorApiKeyMessage4: "క్రొత్త వేరియబుల్‌ను సృష్టించండి. పేరు ఖచ్చితంగా `API_KEY` అయి ఉండాలి. విలువ Google AI స్టూడియో నుండి మీ రహస్య కీ అయి ఉండాలి. వేరియబుల్ పేరులో బ్యాక్‌స్లాష్‌లు (`\\`) లేదా డాష్‌లు (`-`) వంటి చెల్లని అక్షరాలు లేవని నిర్ధారించుకోండి.",
